...
class App(QtWidgets.QApplication):
    ...
    def setup_ui(self):
        ...
        self.cajero.bt_pagar_cuenta.clicked.connect(self.pagar_mesa)
    ...
    def abrir_interfaz_pagar(self):
        ...
        for mesa in self.mesas_impresas:
            ...
            button.clicked.connect(lambda checked, mesa=mesa: self.pagar_mesa(mesa))
            self.interfaz_pagar.verticalLayout.addWidget(button)

    def pagar_mesa(self, numero_mesa):
        # Implementa la lógica para pagar la mesa seleccionada
        print(f"Pagando cuenta de Mesa {numero_mesa}")
